...
def SendMessage(message):
    print('Message to',userid.from_user.first_name,userid.from_user.first_name,message)
...
def handler_text(user):
        print('--------')
        message = user.text
        print('Message from', user.from_user.first_name, user.from_user.first_name, message)
